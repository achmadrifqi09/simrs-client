...
const DeleteBed = ({onRefresh, selectedRecord, action, showAlert, setShowAlert}: DeleteBedProps) => {
            ...
            <AlertDialog open={showAlert} onOpenChange={setShowAlert}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Apakah anda yakin akan menghapus data Kasur{selectedRecord?.nama_bed}?
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
