...
interface BloodTypeTableProps {
    ...
    selectRecord: React.Dispatch<React.SetStateAction<BloodType | null>>
...
const BloodTypeTable = (
    ...
    const {data, loading, error, getData} = useGet<BloodType[]>({
        url: url,
    ...
    return (
        <>
            ...
            <Table>
                ...
                <TableBody>
                    {
                        data?.map((bloodType: BloodType, index: number) => {
                            return (
