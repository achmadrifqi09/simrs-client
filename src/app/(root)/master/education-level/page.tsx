...
import {Education} from "@/types/master";
...
const EducationLevel = () => {
    ...
    const [selectedRecord, setSelectedRecord] = useState<Education | null>(null);
        ...
        <>
            ...
            <Section>
                <div className="space-y-6">
                    {
                        educationLevelPermission?.can_create && (
                    ...
                    {
                        educationLevelPermission?.can_view && (
                            <EducationLevelTable
                    ...
                    {
                        educationLevelPermission?.can_delete && (
