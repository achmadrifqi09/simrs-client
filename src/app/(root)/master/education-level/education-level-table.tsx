...
interface EducationLevelTableProps {
    ...
    selectRecord: React.Dispatch<React.SetStateAction<Education | null>>
...
const EducationLevelTable = (
    ...
    const {data, loading, error, getData} = useGet<Education[]>({
        url: url,
    ...
    return (
        <>
            ...
            <Table>
                ...
                <TableBody>
                    {
                        data?.map((educationLevel: Education, index: number) => {
                            return (
