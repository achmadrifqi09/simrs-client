...
const CountryDelete = ({onRefresh, selectedRecord, action, showAlert, setShowAlert}: DoctotSpecialistProps) => {
    ...
    const handleDelete = async () => {
        if(action === Action.DELETE){
            const result = await deleteData(`/master/doctor-specialist/${selectedRecord?.id_ms_spesialis}`)
            ...
            <AlertDialog open={showAlert} onOpenChange={setShowAlert}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Apakah anda yakin akan menghapus data Negara {selectedRecord?.id_ms_spesialis}?
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
