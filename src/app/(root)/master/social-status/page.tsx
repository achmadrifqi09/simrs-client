...
import {SocialStatus as SocialStatusType} from "@/types/master";
...
const SocialStatus = () => {
    ...
    const [selectedRecord, setSelectedRecord] = useState<SocialStatusType | null>(null);
        ...
        <>
            ...
            <Section>
                <div className="space-y-6">
                    {
                        socialStatusPermission?.can_create && (
                    ...
                    {
                        socialStatusPermission?.can_view && (
                            <SocialStatusTable
                    ...
                    {
                        socialStatusPermission?.can_delete && (
                            <DeleteSocialStatus
                                onRefresh={onRefresh}
                                selectedRecord={selectedRecord}
                                action={actionType}
