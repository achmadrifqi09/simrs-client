...
import BpjsTable from "@/app/(root)/register/onsite/bpjs-table";
import GeneralTable from "@/app/(root)/register/onsite/general-table";
                    ...
                    <div className="flex-1 overflow-auto mt-4">
                        <Tabs defaultValue="BPJS">
                            ...
                            <TabsContent value="Umum" className="px-2">
                                <GeneralTable generalPatient={dataUmum}/>
                            </TabsContent>
                        </Tabs>
                    </div>
                </Section>
