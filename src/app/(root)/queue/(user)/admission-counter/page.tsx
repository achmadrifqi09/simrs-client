...
const QueueData = () => {
    ...
    const handleToCounterDetail = (counterId: number) => {
        Cookies.set('LATEST_COUNTER_ID', counterId.toString());
                    ...
                    {loading || status === 'loading'
                        ...
                        : counters.map((counter: CallingCounter) => (
                              <SolidCard
                                  ...
                                  onClick={() => handleToCounterDetail(counter.id_ms_loket_antrian)}
                              >
                                  <p className="font-medium">
                                      {counter.nama_loket}
                                      {counter?.is_used && ' (Digunakan)'}
                                  </p>
                              </SolidCard>
                          ))}
                    {isEmpty && (
