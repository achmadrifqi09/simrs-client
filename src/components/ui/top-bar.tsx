...
const TopBar = ({ onToggleMenu }: TopBarProps) => {
    ...
    return (
        <div className="flex items-center justify-between bg-gradient-to-br from-red-600 to-red-500 sticky top-0 border-b border-b-gray-300">
            <div className="flex gap-2 items-center bg-transparent md:w-[324px] h-[72px] md:border-r md:border-r-red-300 md:bg-gradient-to-br md:from-orange-600 to-red-600 pl-4 md:pl-6">
                        ...
                        <DropdownMenuTrigger className="active:border-none active:ring-0 focus:border-none focus:ring-0 focus:outline-0">
                            <div className="flex gap-2 items-center text-white">
                                {status === 'loading' ? (
                                    ...
                                    <>
                                        <div className="h-9 w-9 aspect-square bg-red-600 rounded-full font-medium flex select-none items-center justify-center uppercase">
